...
# -----------------------------------------------
epsilon1=1e-5       # prior 1e-5
epsilon2=1        # condition
epsilon3=1e-17    # noise  1e-17 
# -----------------------------------------------
...
# net_weights="nets/gender_classifier/gender_net.caffemodel"
# net_definition="nets/gender_classifier/deploy_gender.prototxt"
# net_weights="nets/face_classifier/VGG_FACE.caffemodel"
# net_definition="nets/face_classifier/VGG_FACE_deploy.prototxt"
# net_weights="nets/nsfw_model/resnet_50_1by2_nsfw.caffemodel"
# net_definition="nets/nsfw_model/deploy.prototxt"
# net_weights="nets/googlenet/googlelet_places205_train_iter_2400000.caffemodel"
# net_definition="nets/googlenet/train_val_googlenet_places205.prototxt"
net_weights="nets/voc/pascalvoc2012_train_simple2_iter_30000.caffemodel"
net_definition="nets/voc/deploy_x30.prototxt"
